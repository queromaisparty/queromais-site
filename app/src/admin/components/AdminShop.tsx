    ...
    <div className="p-8">
      ...
      >
        ...
        <p className="text-sm max-w-sm mx-auto" style={{ color: '#9CA3AF' }}>
          {t({
            pt: 'Módulo de e-commerce e catálogo de produtos em breve.',
            en: 'E-commerce module and product catalog soon.',
            es: 'Módulo de comercio electrónico y catálogo de productos pronto.',
          })}
        </p>
      </div>
    </div>
