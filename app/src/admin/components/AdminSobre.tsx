    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-sm mt-1" style={{ color: '#9CA3AF' }}>
          Construa a Timeline da Quero Mais e gerencie o Storytelling corporativo.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p className="text-sm max-w-sm mx-auto" style={{ color: '#9CA3AF' }}>
          {t({
            pt: 'Módulo para edição estrutural da página Sobre (Timeline Manager) em breve.',
            en: 'Structural editing for About page (Timeline Manager) coming soon.',
            es: 'Edición estructural de la página Sobre (Timeline Manager) pronto.',
          })}
        </p>
      </div>
    </div>
