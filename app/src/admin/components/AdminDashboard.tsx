...
import { AdminDJContest } from './AdminDJContest';
...
export function AdminDashboard({ currentSection, onSectionChange, onLogout, onGoToSite }: AdminDashboardProps) {
  ...
  const menuItems = [
    ...
    { id: 'dj-contest',   label: { pt: 'DJ Contest',       en: 'DJ Contest',   es: 'DJ Contest'   }, icon: Disc },
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 text-slate-900 font-sans">
      ...
      <main className="flex-1 h-[100dvh] overflow-x-hidden overflow-y-auto pt-16 lg:pt-0 scroll-smooth">
        ...
        {currentSection === 'dj-contest' && <div className="p-6 lg:p-10 max-w-7xl mx-auto"><AdminDJContest /></div>}
