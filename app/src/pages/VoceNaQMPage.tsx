              ...
              {sortedAlbums.length === 0 ? (
                ...
                sortedAlbums.map(album => (
                  <div 
                    ...
                    className="group cursor-pointer bg-white border border-gray-200 rounded-3xl overflow-hidden hover:border-[#E91E8C]/50 transition-colors shadow-sm hover:shadow-xl flex flex-col"
                  >
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500 mt-4">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <button 
                ...
                className="flex items-center gap-2 text-gray-600 hover:text-black transition-colors font-semibold group bg-white border border-gray-200 hover:bg-gray-50 px-4 py-2 rounded-lg w-fit shadow-sm"
              >
        ...
        {selectedPhoto && (
          <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-xl flex items-center justify-center p-4 sm:p-8 animate-in fade-in duration-300">
             <button 
               ...
               className="absolute top-6 right-6 text-white/50 hover:text-white bg-white/10 hover:bg-white/20 w-12 h-12 rounded-full flex items-center justify-center transition-all"
             >
               ✕
             </button>
             
             <img src={selectedPhoto} alt="Foto Ampliada" className="max-w-full max-h-full object-contain rounded-lg shadow-2xl" />
             
             <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/80 backdrop-blur-md px-6 py-3 rounded-full border border-white/10">
               <button className="text-white hover:text-[#E91E8C] flex items-center gap-2 text-sm font-bold transition-colors">
