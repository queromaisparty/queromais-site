    ...
    <>
      ...
      {!showForm && !success && (
        <button
          ...
          className="flex items-center justify-between w-full px-6 sm:px-8 py-3 sm:py-4 bg-[#3D3D3D] hover:bg-[#2A2A2A] text-white rounded-full text-xs sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.2em] uppercase transition-colors font-sans"
        >
