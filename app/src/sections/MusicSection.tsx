...
function SocialIcon({ platform }: { platform: string }) {
  ...
  if (p === 'instagram') return <FaInstagram size={16} />;
  if (p === 'soundcloud') return <FaSoundcloud size={16} />;
  if (p === 'spotify') return <FaSpotify size={16} />;
  if (p === 'youtube') return <FaYoutube size={16} />;
