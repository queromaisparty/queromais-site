                    ...
                    {(event.ticketLinks ?? []).length > 0 ? (
                      (event.ticketLinks ?? []).map((link) => (
                        <a
                           ...
                           className="flex items-center justify-between w-full max-w-[320px] px-6 sm:px-8 py-3 sm:py-4 bg-[#5D2C45] hover:bg-[#4A1F35] text-white rounded-full text-xs sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.2em] uppercase transition-colors font-sans"
                         >
